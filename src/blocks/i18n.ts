...
export type UiLocale = "zh-CN" | "zh-TW" | "en" | "ja" | "es" | "fr" | "de" | "ar";
...
const fr: Dict = {
	...en,
	"nav.explore": "Bibliothèque",
	"nav.submit": "+ Proposer",
	"nav.submit_short": "Proposer",
	"nav.ui_lang": "Langue",
	"explore.title": "Blocks communautaires",
	"explore.sub":
		"Listes officielles et communautaires — choisissez celles à ajouter à l'accueil.",
	"explore.search_ph": "Rechercher titre / auteur",
	"explore.all_langs": "Toutes les langues",
	"explore.cat.all": "Tout",
	"explore.cat.movie": "Films",
	"explore.cat.tv": "Séries",
	"explore.cat.anime": "Anime",
	"explore.cat.collection": "Collections",
	"explore.cat.homepage": "Accueils",
	"explore.make_group": "Créer une collection",
	"explore.make_home": "Créer un accueil",
	"explore.cancel": "Annuler",
	"explore.done": "Terminé",
	"explore.pick_hint":
		"Choisissez des blocs · touchez pour ajouter, pages multiples",
	"explore.pick_hint_n":
		"{n} sélectionnés · conservés entre les pages · Terminé pour modifier",
	"explore.step_pick": "1. Choisir",
	"explore.step_edit": "2. Modifier",
	"explore.step_preview": "3. Aperçu",
	"explore.selected": "Sélection",
	"explore.empty_cat": "Rien ici pour l'instant — proposer un bloc ?",
	"explore.empty_home":
		"Aucun accueil publié. Sélectionnez des blocs et touchez « Créer un accueil ».",
	"explore.prev": "Précédent",
	"explore.next": "Suivant",
	"explore.page_n": "Page {n}",
	"explore.pager": "Pagination",
	"tag.collection": "Collection",
	"tag.homepage": "Accueil",
	"block.meta_charts": "{n} listes · {installs} installations",
	"block.meta_items": "{n} éléments · {installs} installations",
	"block.meta_home": "{n} blocs · {installs} installations",
	"block.install": "Installer",
	"sel.selected_n": "{n} sélectionnés",
	"sel.selected_cross": "{n} sélectionnés (multi-pages)",
	"sel.publish_group": "Publier la collection",
	"group.title_ph": "Titre de la collection, ex. Anime du jour",
	"group.mode_custom": "Personnalisé",
	"group.mode_weekday": "Par jour",
	"group.style_label": "Style de collection",
	"group.style_capsule": "Capsule",
	"group.style_rank": "Classement",
	"group.style_banner": "Bannière",
	"group.style_image": "Image",
	"group.style_landscape": "Paysage",
	"group.style_portrait": "Portrait",
	"group.create": "Créer et publier",
	"group.admin_hint":
		"Admin : publier une collection dans la bibliothèque sous forme de cartes capsule.",
	"pack.back_pick": "Continuer à choisir",
	"pack.edit_title": "Modifier l'accueil",
	"pack.edit_sub": "⋮⋮ Glisser pour réordonner · changer les styles ci-dessous",
	"pack.preview": "Aperçu",
	"pack.preview_title": "Aperçu de l'accueil",
	"pack.preview_sub":
		"Identique à la page publique · publiez quand vous êtes prêt",
	"pack.label_title": "Titre",
	"pack.title_ph": "ex. Sélection du week-end",
	"pack.label_author": "Auteur",
	"pack.optional_ph": "Facultatif",
	"pack.label_desc": "Description",
	"pack.preview_home": "Aperçu de l'accueil",
	"pack.back_edit": "Retour à l'édition",
	"pack.confirm": "Publier",
	"pack.copy_link": "Copier le lien",
	"pack.view_home": "Voir l'accueil",
	"pack.publish_home": "Publier l'accueil",
	"style.thumb": "Vignette",
	"style.poster": "Affiche",
	"style.hero": "Hero",
	"style.show": "Affichage",
	"style.rank_num": "Rang",
	"style.overview": "Synopsis",
	"style.drag": "Glisser pour réordonner",
	"chip.other_page": " · autre page",
	"wd.1": "Lun",
	"wd.2": "Mar",
	"wd.3": "Mer",
	"wd.4": "Jeu",
	...
	"wd.6": "Sam",
	"wd.7": "Dim",
	"msg.need_one_block": "Sélectionnez au moins un bloc",
	"msg.pick_blocks_first": "Sélectionnez d'abord des blocs",
	"msg.need_group_title": "Saisissez un titre de collection",
	"msg.group_min2": "Une collection nécessite au moins 2 listes",
	"msg.group_max7": "Le mode par jour autorise au plus 7 listes",
	"msg.need_labels": "Étiquetez chaque liste",
	"msg.publishing": "Publication…",
	"msg.publish_fail": "Échec de la publication",
	"msg.network": "Erreur réseau",
	"msg.group_published": "Publié · {id} (actualisez pour le voir)",
	"msg.need_home_title": "Saisissez un titre d'accueil",
	"msg.loading_preview": "Chargement de l'aperçu…",
	"msg.preview_fail": "Échec du chargement de l'aperçu",
	"msg.untitled_home": "Accueil sans titre",
	"msg.home_meta_confirm": "{n} blocs · publiez quand vous êtes prêt",
	"msg.home_published":
		"Accueil publié. Retrouvez-le sous Accueils, ou ouvrez le lien sur iPhone pour l'importer.",
	"msg.copied_import": "Lien d'import copié",
	"msg.preview_unavailable": "Aperçu indisponible",
	"msg.preview_in_app": "Ce bloc s'affiche dans l'app",
	"msg.collection_nested":
		" (les collections ne peuvent pas s'imbriquer — ignoré)",
	"group.label_ph": "Étiquette",
	"hp.sub":
		"{n} blocs · {installs} installations. Sur iPhone, installez-le comme nouvel accueil.",
	"hp.install": "Installer dans l'app",
	"hp.copy": "Copier le lien",
	"submit.title": "Proposer un Block",
	"submit.sub":
		"Ajoutez une source de données et les options d'affichage. Les admins récupèrent et examinent avant publication.",
	"submit.token": "Jeton API TMDB (obligatoire — utilisé lors du scraping admin)",
	"submit.token_ph": "Jeton d'accès commençant par eyJ",
	"submit.token_hint_before": "Validé à l'envoi. Obtenez-en un sur",
	"submit.token_hint_link": "TMDB",
	"submit.token_hint_after": ".",
	"submit.category": "Catégorie",
	"submit.name": "Titre",
	"submit.name_ph": "ex. Meilleurs dramas mystère",
	"submit.language": "Langue (titres et synopsis TMDB)",
	"submit.source": "URL / données de la liste",
	"submit.source_ph":
		'Une URL d\'API, ex. /tmdb/trending/movie ou une URL complète\nou collez du JSON, ex. [{"id":603,"title":"The Matrix"}, ...]',
	"submit.source_hint":
		"Fournissez un endpoint de liste ou collez du JSON. Les admins s'occupent de la récupération.",
	"submit.preset": "Mise en page",
	"submit.preset_thumb": "Vignettes",
	"submit.preset_poster": "Affiches",
	"submit.preset_hero": "Hero",
	"submit.ov_note":
		"Les synopsis n'apparaissent qu'en mise en page vignettes, pas affiches/hero.",
	"submit.show_rank": "Afficher le classement",
	"submit.show_overview": "Afficher le synopsis",
	"submit.author": "Crédit (facultatif)",
	"submit.author_ph": "Pseudo, facultatif",
	"submit.btn": "Envoyer pour examen",
	"submit.submitting": "Envoi…",
	"submit.submitted": "Envoyé",
	"submit.ok": "Envoyé ! Il apparaîtra dans la bibliothèque après approbation.",
	"submit.err_token": "Saisissez un jeton TMDB",
	"submit.err_title": "Saisissez un titre",
	"submit.err_source": "Saisissez une URL ou collez des données",
	"submit.err_fail": "Échec de l'envoi",
	"import.sub":
		"{n} blocs · Ouvrez sur iPhone pour importer dans EplayerX comme nouvel accueil.",
	"import.open": "Ouvrir dans l'app",
	"import.download": "Télécharger EplayerX",
};

const de: Dict = {
	...en,
	"nav.explore": "Bibliothek",
	"nav.submit": "+ Einreichen",
	"nav.submit_short": "Einreichen",
	"nav.ui_lang": "Sprache",
	"explore.title": "Community-Blocks",
	"explore.sub":
		"Offizielle und Community-Listen — wählen Sie, was auf den Startbildschirm soll.",
	"explore.search_ph": "Titel / Autor suchen",
	"explore.all_langs": "Alle Sprachen",
	"explore.cat.all": "Alle",
	"explore.cat.movie": "Filme",
	"explore.cat.tv": "Serien",
	"explore.cat.anime": "Anime",
	"explore.cat.collection": "Sammlungen",
	"explore.cat.homepage": "Startseiten",
	"explore.make_group": "Sammlung erstellen",
	"explore.make_home": "Startseite erstellen",
	"explore.cancel": "Abbrechen",
	"explore.done": "Fertig",
	"explore.pick_hint":
		"Blöcke wählen · antippen zum Hinzufügen, seitenübergreifend",
	"explore.pick_hint_n":
		"{n} ausgewählt · bleibt über Seiten · Fertig zum Bearbeiten",
	"explore.step_pick": "1. Auswählen",
	"explore.step_edit": "2. Bearbeiten",
	"explore.step_preview": "3. Vorschau",
	"explore.selected": "Ausgewählt",
	"explore.empty_cat": "Hier ist noch nichts — Block einreichen?",
	"explore.empty_home":
		"Noch keine veröffentlichten Startseiten. Blöcke wählen und „Startseite erstellen“ tippen.",
	"explore.prev": "Zurück",
	"explore.next": "Weiter",
	"explore.page_n": "Seite {n}",
	"explore.pager": "Seiten",
	"tag.collection": "Sammlung",
	"tag.homepage": "Startseite",
	"block.meta_charts": "{n} Listen · {installs} Installationen",
	"block.meta_items": "{n} Einträge · {installs} Installationen",
	"block.meta_home": "{n} Blöcke · {installs} Installationen",
	"block.install": "Installieren",
	"sel.selected_n": "{n} ausgewählt",
	"sel.selected_cross": "{n} ausgewählt (seitenübergreifend)",
	"sel.publish_group": "Sammlung veröffentlichen",
	"group.title_ph": "Sammlungstitel, z. B. Tägliches Anime",
	"group.mode_custom": "Benutzerdefiniert",
	"group.mode_weekday": "Nach Wochentag",
	"group.style_label": "Sammlungsstil",
	"group.style_capsule": "Kapsel",
	"group.style_rank": "Rang",
	"group.style_banner": "Banner",
	"group.style_image": "Bild",
	"group.style_landscape": "Querformat",
	"group.style_portrait": "Hochformat",
	"group.create": "Erstellen & veröffentlichen",
	"group.admin_hint":
		"Admin: Sammlung als Kapselkarten in der Bibliothek veröffentlichen.",
	"pack.back_pick": "Weiter auswählen",
	"pack.edit_title": "Startseite bearbeiten",
	"pack.edit_sub": "⋮⋮ Ziehen zum Sortieren · Stile darunter ändern",
	"pack.preview": "Vorschau",
	"pack.preview_title": "Startseiten-Vorschau",
	"pack.preview_sub":
		"Wie die öffentliche Detailseite · veröffentlichen wenn bereit",
	"pack.label_title": "Titel",
	"pack.title_ph": "z. B. Wochenend-Tipps",
	"pack.label_author": "Autor",
	"pack.optional_ph": "Optional",
	"pack.label_desc": "Beschreibung",
	"pack.preview_home": "Startseite vorschauen",
	"pack.back_edit": "Zurück zur Bearbeitung",
	"pack.confirm": "Veröffentlichen",
	"pack.copy_link": "Link kopieren",
	"pack.view_home": "Startseite ansehen",
	"pack.publish_home": "Startseite veröffentlichen",
	"style.thumb": "Miniatur",
	"style.poster": "Poster",
	"style.hero": "Hero",
	"style.show": "Anzeige",
	"style.rank_num": "Rang",
	"style.overview": "Handlung",
	"style.drag": "Ziehen zum Sortieren",
	"chip.other_page": " · andere Seite",
	"wd.1": "Mo",
	"wd.2": "Di",
	"wd.3": "Mi",
	"wd.4": "Do",
	...
	"wd.6": "Sa",
	"wd.7": "So",
	"msg.need_one_block": "Mindestens einen Block wählen",
	"msg.pick_blocks_first": "Zuerst Blöcke wählen",
	"msg.need_group_title": "Sammlungstitel eingeben",
	"msg.group_min2": "Eine Sammlung braucht mindestens 2 Listen",
	"msg.group_max7": "Wochentagsmodus erlaubt höchstens 7 Listen",
	"msg.need_labels": "Jede Liste beschriften",
	"msg.publishing": "Wird veröffentlicht…",
	"msg.publish_fail": "Veröffentlichen fehlgeschlagen",
	"msg.network": "Netzwerkfehler",
	"msg.group_published": "Veröffentlicht · {id} (aktualisieren zum Anzeigen)",
	"msg.need_home_title": "Startseitentitel eingeben",
	"msg.loading_preview": "Vorschau wird geladen…",
	"msg.preview_fail": "Vorschau konnte nicht geladen werden",
	"msg.untitled_home": "Unbenannte Startseite",
	"msg.home_meta_confirm": "{n} Blöcke · veröffentlichen wenn bereit",
	"msg.home_published":
		"Startseite veröffentlicht. Unter Startseiten finden oder den Link auf dem iPhone zum Import öffnen.",
	"msg.copied_import": "Import-Link kopiert",
	"msg.preview_unavailable": "Vorschau nicht verfügbar",
	"msg.preview_in_app": "Dieser Block wird in der App angezeigt",
	"msg.collection_nested":
		" (Sammlungen können nicht verschachtelt werden — übersprungen)",
	"group.label_ph": "Bezeichnung",
	"hp.sub":
		"{n} Blöcke · {installs} Installationen. Auf dem iPhone als neuen Startbildschirm installieren.",
	"hp.install": "In der App installieren",
	"hp.copy": "Link kopieren",
	"submit.title": "Block einreichen",
	"submit.sub":
		"Datenquelle und Anzeigeoptionen angeben. Admins holen und prüfen vor der Aufnahme.",
	"submit.token": "TMDB-API-Token (erforderlich — für Admin-Scraping)",
	"submit.token_ph": "Read-Access-Token beginnend mit eyJ",
	"submit.token_hint_before": "Wird beim Senden geprüft. Holen Sie eines von",
	"submit.token_hint_link": "TMDB",
	"submit.token_hint_after": ".",
	"submit.category": "Kategorie",
	"submit.name": "Titel",
	"submit.name_ph": "z. B. Beste Mystery-Dramen",
	"submit.language": "Sprache (TMDB-Titel & Handlungen)",
	"submit.source": "Listen-URL / Daten",
	"submit.source_ph":
		'Eine Listen-API-URL, z. B. /tmdb/trending/movie oder eine volle URL\noder JSON einfügen, z. B. [{"id":603,"title":"The Matrix"}, ...]',
	"submit.source_hint":
		"Listen-Endpunkt oder JSON angeben. Admins kümmern sich um Abruf und Bereinigung.",
	"submit.preset": "Layout",
	"submit.preset_thumb": "Miniaturen",
	"submit.preset_poster": "Poster",
	"submit.preset_hero": "Hero",
	"submit.ov_note":
		"Handlungen nur im Miniatur-Layout, nicht bei Poster/Hero.",
	"submit.show_rank": "Rangnummern anzeigen",
	"submit.show_overview": "Handlung anzeigen",
	"submit.author": "Nennung (optional)",
	"submit.author_ph": "Spitzname, optional",
	"submit.btn": "Zur Prüfung senden",
	"submit.submitting": "Wird gesendet…",
	"submit.submitted": "Gesendet",
	"submit.ok": "Gesendet! Erscheint nach Freigabe in der Bibliothek.",
	"submit.err_token": "TMDB-Token eingeben",
	"submit.err_title": "Titel eingeben",
	"submit.err_source": "Listen-URL eingeben oder Daten einfügen",
	"submit.err_fail": "Senden fehlgeschlagen",
	"import.sub":
		"{n} Blöcke · Auf dem iPhone öffnen, um in EplayerX als neue Startseite zu importieren.",
	"import.open": "In der App öffnen",
	"import.download": "EplayerX holen",
};
